...
<body>
	...
	<div class="navbar-nav">
		<a class="nav-item nav-link" href="sachcontroller">San pham</a>
		...
		%>
		<a class="nav-link" href="ktdncontroller"><%=session.getAttribute("un")%></a>
		<%
			} else {
		%>
		<a class="nav-link" href="ktdncontroller">Dang nhap</a>
		<%
			}
		%>
