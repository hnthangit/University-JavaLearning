...
public class GioHangBo {
	...
	public void Them(String masach, String tensach, String tacgia, String anh, long soluong, long gia) {
		int count = -1;
		...
		if (count == -1) {
			GioHangBean gh = new GioHangBean(masach, tensach, tacgia, anh, soluong, gia);
			ds.add(gh);
		} else {
			ds.get(count).setSoluong(ds.get(count).getSoluong() + 1);
			ds.get(count).setThanhtien();
		}
